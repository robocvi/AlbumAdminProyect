...
import mx.unam.ciencias.icc.red.ServidorBaseDeDatosAlbumes;

/**
 * Servidor Proyecto 3: Parte del servidor para el proyecto 3
 *
 */
public class ServidorProyecto3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ServidorBaseDeDatosAlbumes servidor;
            servidor = new ServidorBaseDeDatosAlbumes(puerto, archivo);
